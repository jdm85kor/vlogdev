...
const awsmobile = (() => ({
    ...
    "oauth": {
        ...
        "redirectSignIn": process.env.NODE_ENV === 'development' ? "http://localhost:3000/" : "https://v-log.dev/",
        "redirectSignOut": process.env.NODE_ENV === 'development' ? "http://localhost:3000/" : "https://v-log.dev/",
        "responseType": "code"
    },
