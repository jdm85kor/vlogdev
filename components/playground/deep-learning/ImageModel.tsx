...
const  DigitModel = () => {
  ...
  const loadMobilenet = async () => {
    mobilenet.current = await window.tf.loadLayersModel('https://storage.googleapis.com/tfjs-models/tfjs/mobilenet_v1_1.0_224/model.json');
  ...
  return (
    ...
    `}>
      ...
      <div>
        ...
        <button type="button" id="0" onClick={e => handleButton(e)} >Rock</button>
        <button type="button" id="1" onClick={e => handleButton(e)} >Paper</button>
        <button type="button" id="2" onClick={e => handleButton(e)} >Scissors</button>
        <button type="button" id="3" onClick={e => handleButton(e)} >Spock</button>
        <button type="button" id="4" onClick={e => handleButton(e)} >Lizard</button>
