  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:url" content="https://v-log.dev/playground/deep_learning/start/" />
        ...
        <meta name="twitter:url" content="https://v-log.dev/playground/deep_learning/start/" />
